...
async function carregarProjecao() {
    ...
    console.log(lancamentosRecorrentesDetalhado);
...
async function preencherMaxDeveGastarMesAtual(projecoes, categorias, saidas, contas, entradas, lancamentosRecorrentes, lancamentosRecorrentesDetalhado, meses) {
    ...
    console.log(contas);
    console.log(creditoMesAtual);
    console.log(entradaRestante);
    console.log(valorContas);
    console.log(totalMaxLancRecorrente);
    console.log(totalMaxVerbaCategoria);
    console.log(saldoLancamentoRecorrente);
    console.log(saldoVerbas);
    console.log(saldo);
...
function calcularPrevisaoEntradaExtra(entradas, lancamentosRecorrentes, lancamentosRecorrentesDetalhado, mesAtual, anoAtual) {
    ...
    console.log("\n\nPrevisaoEntradaExtra:");
    console.log(lancamentosRecorrentesDetalhado);
    console.log(entradasFixa);
    console.log(entradasDetalhado);
